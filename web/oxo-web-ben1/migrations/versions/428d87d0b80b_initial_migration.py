...
def upgrade():
    ...
    with op.batch_alter_table("projects", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_projects_project_key"), ["project_key"], unique=True
        )
    ...
    with op.batch_alter_table("cached_issues", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_cached_issues_issue_key"), ["issue_key"], unique=True
        )
        batch_op.create_index(
            batch_op.f("ix_cached_issues_project_key"), ["project_key"], unique=False
        )
